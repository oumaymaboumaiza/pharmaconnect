...
export default function DoctorsPage() {
  ...
  const updateDoctor = async () => {
    ...
    try {
      const response = await axios.put(`http://localhost:5000/api/doctors/${editingDoctor}`, {
        firstName: prenom,
        lastName: nom,
        email,
        cin,
  ...
  const toggleActive = async (id, currentStatus) => {
    try {
      const response = await axios.put(`http://localhost:5000/api/doctors/${id}/status`, {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-blue-100 text-lg">Gérez votre équipe médicale professionnelle</p>
            </div>
          </div>

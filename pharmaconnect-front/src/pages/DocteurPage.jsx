              ...
              <div className="flex gap-2 flex-wrap">
                ...
                <Dialog>
                  ...
                  <DialogContent className="p-6">
                    <h3 className="text-lg font-semibold mb-4">Détails du médecin</h3>
                    <div className="space-y-2">
                      <p><strong>Nom:</strong> {doc.nom} {doc.prenom}</p>
                      <p><strong>Email:</strong> {doc.email}</p>
                      <p><strong>CIN:</strong> {doc.cin}</p>
                      <p><strong>Spécialité:</strong> {doc.specialty}</p>
                      <p><strong>Statut:</strong> {doc.is_active ? 'Actif' : 'Désactivé'}</p>
                    </div>
                  </DialogContent>
                </Dialog>
                <Button 

...
import { Store, Package, Settings, User, Home, LogOut } from "lucide-react"
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Système de gestion</p>
              </div>
            </div>
          </div>
          ...
          <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-2">
            <div className="mb-6">
              ...
              {/* Add Dashboard as the first navigation item */}
              <div className="space-y-2">
                <NavItem to="/admin/dashboard" icon={<Home size={20} />} label="Tableau de Bord" />

                {["admin"].includes(role) && (
                  <>
                    <NavItem to="/pharmacies" icon={<Store size={20} />} label="Gestion Pharmacies" />
                    <NavItem to="/admin/doctors" icon={<User size={20} />} label="Gestion Médecins" />
                  </>
                )}
              </div>
            </div>
